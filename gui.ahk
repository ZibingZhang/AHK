...
gui_autoexecute:
    ...
    gui_control_options := "xm w220 " . cForeground . " -E0x200 Center"
...
gui_spawn:
    ...
    Gui, Add, Text, %gui_control_options% vgui_main_title, »» ————— ⚜ ————— ««
    Gui, Font, s10 , Segoe UI
    Gui, Add, Edit, %gui_control_options% vCommand gFindus -VScroll hwndEdit +Multi h25
    Gui, Show
    Edit_VCENTER(Edit)
    return
...
gui_search(color, url) {
    ...
    if gui_state != search
    {
        ...
        ; Add GUI controls to allow typing of a search query.
        Gui, Add, Text, %gui_control_options% %color%, %gui_search_title%
        Gui, Add, Edit, %gui_control_options% %color% vgui_SearchEdit -WantReturn -VScroll hwndEdit +Multi h25
...
gui_commandlibrary:
    ...
    ToolTipFont("s10 q6", "Courier New")
    ToolTip %tooltiptextpadded%, 3, 3, 1
    return

; https://www.autohotkey.com/boards/viewtopic.php?style=17&t=63180
